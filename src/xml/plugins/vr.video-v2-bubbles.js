  ...
  **************************************************************************/
  ...
  function build_scene() {
    ...
    var geometry = new THREE.BoxGeometry(1920,1080,1);
        ...
        var parameters = { fragmentShader: shader.fragmentShader, vertexShader: shader.vertexShader, uniforms: uniforms, transparent: true, opacity: .5 };
        var materialsphere = new THREE.ShaderMaterial( parameters );
