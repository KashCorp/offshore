...
;(function ($) {
    ...
    function Booklet(inTarget, inOptions) {
        ...
        //page content vars
            pL, pN, p0, p1, p2, p3, p4, pFwrap, pNwrap, p0wrap, p1wrap, p2wrap, p3wrap, p4wrap, wraps, sF, sB,
        //control vars
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Page = function (contentNode, index, options) {
                ...
                } else if(options.closed && options.covers && index == 1) {
                    contentNode.wrap('<div class="b-page"><div class="b-wrap b-page-cover"></div></div>');
                    
                } else if(options.closed && options.covers && index == 2) {
                    contentNode.wrap('<div class="b-page"><div class="b-wrap b-page-cover-inside"></div></div>');

                } else if(options.closed && options.covers && index == options.pageTotal - 3) {
                    contentNode.wrap('<div class="b-page"><div class="b-wrap b-page-cover-back-inside"></div></div>');
                    

                } else if(options.closed && options.covers && index == options.pageTotal - 2) {
                    contentNode.wrap('<div class="b-page"><div class="b-wrap b-page-cover-back"></div></div>');
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            updatePageStructure = function () {
                // reset all content
                console.log("update page structures")
                target.find('.b-page').removeClass('b-pL,b-pN b-p0 b-p1 b-p2 b-p3 b-p4').hide();
                ...
                console.log("going through")
                    target.find('.b-page-' + (options.currentIndex - 2)).addClass('b-pN').fadeIn(500);
                    target.find('.b-page-' + (options.currentIndex - 1)).addClass('b-p0').fadeIn(500);
                }
                
              // if(options.closed && options.covers && index == options.pageTotal - 3) {
                ...
                if(options.currentIndex + 3 <= options.pageTotal) {
                    target.find('.b-page-' + (options.currentIndex + 2)).addClass('b-p3').fadeIn(500);
                    target.find('.b-page-' + (options.currentIndex + 3)).addClass('b-p4').fadeIn(500);
                }
                
                if(options.closed && options.covers) {
                 console.log("make cover")
                 //target.find('.b-page-' + (options.pageTotal - 3)).css({'position':'absolute', 'left': 450});
                 target.find('.b-page-' + (options.pageTotal - 3)).addClass('b-pL').show();
                }                
                ...
                p3 = target.find('.b-p3');
                p4 = target.find('.b-p4');
                pLwrap = target.find('.b-pL .b-wrap');
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            startPageAnimation = function (diff, inc, shadow, speed) {
                ...
                if(options.closed && options.autoCenter) {
                 console.log("opening book to "+ pWidth)
                  console.log(pL)
                    if(options.currentIndex == 0) {
                       console.log("Ending1")
                        p3.hide();
                        p4.hide();
                        pL.animate({left: 0}, speed*2, options.easing)
                        ...
                        pL.animate({left: pWidth}, speed*2, options.easing)
