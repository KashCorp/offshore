  ...
  <a class="volume-toggle"><i class="icon-volume-up"></i></a>
    ...
    <div id="wrapper" class="wrapper" style="display:block">
      ...
      <div id="scan_image_lines"></div>
          ...
          <div id="filingcabinet-container">

          <ul>
            <li data-label="5"><img class="photo" style="top:0px;width:70%;left:30%" src="images/dossier/04.jpg"></li>
            <li data-label="4"><img class="photo" style="top:20px;width:70%;left:30%" src="images/dossier/03.jpg"></li>
            <li data-label="3"><img class="photo" style="top:40px;width:70%;left:30%" src="images/dossier/02.jpg"></li>
            <li data-label="2"><img class="photo" style="top:60px;width:70%;left:30%" src="images/dossier/01.jpg"></li>
            <li data-label="1" ><img style="-webkit-transform: rotate(-90deg);top:140px;width:70%;left:30%" src="images/folder_front.png"></li>
          </ul>
      ...
      $("ul li").click(function(){ 
        ...
        var that = this
         $('ul li').each(function(i, v){
            ...
            if(this==that){
               $(this).css('z-index', '1');
               $(this).css('-webkit-transform', 'translate3d(200px,-20px,100px)');

            }else{
               $(this).css('z-index', '-1');
              $(this).css('-webkit-transform', 'translate3d(0px,0,0px)');
            }
        });
